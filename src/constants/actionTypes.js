...
export const SET_IS_HOVERING_TAG = 'SET_IS_HOVERING_TAG';
export const REMEMBER_COORDINATE_RANGE = 'REMEMBER_COORDINATE_RANGE';
export const FORGET_COORDINATE_RANGE = 'FORGET_COORDINATE_RANGE';
