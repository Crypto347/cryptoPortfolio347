...
export const FETCH_ARCHIEVE_BEGIN = 'FETCH_ARCHIEVE_BEGIN';
export const FETCH_ARCHIEVE_SUCCESS = 'FETCH_ARCHIEVE_SUCCESS';
export const FETCH_ARCHIEVE_FAILURE = 'FETCH_ARCHIEVE_FAILURE';
