    ...
    const highlightsPage = [
        {
            ...
            text: [
                {
                    id: 11,
                    normalText: "Lorem ipsum dolor sit amet, nec in adipiscing purus luctus, urna pellentesque fringilla vel, non sed arcu integer, mauris ullamcorper ante ut non torquent. Justo praesent, vivamus eleifend torquent, suspendisse etiam lorem vestibulum, vestibulum in lorem nec vel, sit curabitur dui ligula vehicula quam.",
                    highlightedText: "Nec in neque mauris, enim hac risus in lorem. Mi risus, feugiat egestas nunc vehicula vehicula libero.",
                    highlightsBackground: "black",
                    highlightsColor: "white"
                },
                {
                    id: 12,
                    normalText: "Nec sit ante, amet dictum sem suspendisse mollis magna placerat, sapien arcu non sit mollis quis, praesent maecenas augue tortor parturient integer in, aliquam tempus ultricies elit dis vivamus aut.",
                    highlightedText: "Ipsum non ut egestas in, suspendisse ut.",
                    highlightsBackground: "black",
                    highlightsColor: "white"
                },
                {
                    id: 13,
                    normalText: "Sodales sed cras. Et consequat viverra. Orci urna etiam, consequat rhoncus in et.",
...
app.get('/api/dropcaps-page', (req, res) => {
    const dropcapsPage = [
            ...
            text: [
                {
                    ...
                    dropcapsBackground: "trnsparent",
                    dropcapsColor: "black",
                    dropcapsStyle: "normal",
                    dropcapsFontSize: 45
                },
                {
                    id: 12,
        ...
        {
            id: 2,
            key: "dropcapsPageStyle2",
            text: [
                {
                    id: 21,
                    text: "Morem ipsum dolor. Sit amet non. Libero varius ligula a id nec libero amet non metus ligula risus egestas senectus euismod. In vel tristique. Nulla risus aliquam venenatis ut feugiat. Suspendisse nec ultricies. Pulvinar fusce varius consequat quis ornare. Tellus ridiculus quisque. Ullamcorper pulvinar pede. Sem porta sit nibh vivamus et. Aenean sollicitudin in elit sed id. Justo et netus tempus cras quam. Ac urna pellentesque vitae posuere libero. Con sed suspendisse tristique nisl magna nulla felis placerat quis lacus assumenda.",
                    dropcapsBackground: "black",
                    dropcapsColor: "rgb(248, 248, 248)",
                    dropcapsStyle: "square",
                    dropcapsFontSize: 22
                },
                {
                    id: 22,
                    text: "Morem ipsum dolor. Sit amet non. Libero varius ligula a id nec libero amet non metus ligula risus egestas senectus euismod. In vel tristique. Nulla risus aliquam venenatis ut feugiat. Suspendisse nec ultricies. Pulvinar fusce varius consequat quis ornare. Tellus ridiculus quisque. Ullamcorper pulvinar pede. Sem porta sit nibh vivamus et. Aenean sollicitudin in elit sed id. Justo et netus tempus cras quam. Ac urna pellentesque vitae posuere libero. Con sed suspendisse tristique nisl magna nulla felis placerat quis lacus assumenda.",
                    dropcapsBackground: "rgb(218, 153, 83)",
                    dropcapsColor: "rgb(248, 248, 248)",
                    dropcapsStyle: "square",
                    dropcapsFontSize: 22
                },
                {
                    id: 23,
                    text: "Morem ipsum dolor. Sit amet non. Libero varius ligula a id nec libero amet non metus ligula risus egestas senectus euismod. In vel tristique. Nulla risus aliquam venenatis ut feugiat. Suspendisse nec ultricies. Pulvinar fusce varius consequat quis ornare. Tellus ridiculus quisque. Ullamcorper pulvinar pede. Sem porta sit nibh vivamus et. Aenean sollicitudin in elit sed id. Justo et netus tempus cras quam. Ac urna pellentesque vitae posuere libero. Con sed suspendisse tristique nisl magna nulla felis placerat quis lacus assumenda.",
                    dropcapsBackground: "rgb(155, 155, 155)",
                    dropcapsColor: "rgb(248, 248, 248)",
                    dropcapsStyle: "square",
                    dropcapsFontSize: 22
                },
    ...
    res.json(dropcapsPage);
});

app.get('/api/columns-page', (req, res) => {
    const columnsPage = [
        {
            id: 1,
            key: "columnsPage2ColumnsNormal",
            header: "II Columns Layout",
            data: [
                {
                    id: 11,
                    text: "Nam ei eirmod consequuntur, quod nostrum consectetuer usu ut. Vim veniam singulis senserit an, sumo consul mentitum duo ea. Copiosae antiopam ius ea, meis explicari reformidans vix.",
                    columnWidth: 50
                },
                {
                    id: 12,
        ...
        {
            id: 2,
            key: "columnsPage3ColumnsNormal",
            header: "III Columns Layout",
            data: [
                {
                    id: 21,
                    text: "Nam ei eirmod consequuntur, quod nostrum consectetuer usu ut. Vim veniam singulis senserit an, sumo consul mentitum duo ea.",
                    columnWidth: 33.3
                },
                {
                    id: 22,
        ...
        {
            id: 3,
            key: "columnsPage4ColumnsNormal",
            header: "IV Columns Layout",
            data: [
                {
                    id: 31,
                    text: "Nam ei eirmod consequuntur, quod nostrum consectetuer usu ut. Vim veniam singulis senserit.",
                    columnWidth: 25
                },
                {
                    id: 32,
        ...
        {
            id: 4,
            key: "columnsPage2Columns1Fourth3Fourth",
            header: "I Fourth / III Fourths",
            data: [
                {
                    id: 41,
                    text: "Nam ei eirmod consequuntur, quod nostrum consectetuer usu ut. Vim veniam singulis senserit.",
                ...
                {
                    id: 42,
                    text: "Nam ei eirmod consequuntur, quod nostrum consectetuer usu ut. Vim veniam singulis senserit an, sumo consul mentitum duo ea. Copiosae antiopam ius ea, meis explicari reformidans vix cu.Ut possit patrioque prodesset est, vivendum concludaturque conclusion emque.",
                    columnWidth: 75
                }                
            ]
        },
        {
            id: 5,
            key: "columnsPage2Columns2Thirds1Third",
            header: "II Thirds / I Third",
            data: [
                {
                    id: 51,
                    text:  "Nam ei eirmod consequuntur, quod nostrum consectetuer usu ut. Vim veniam singulis senserit an, sumo consul mentitum duo ea. Copiosae antiopam ius ea, meis explicari reformidans vix cu.Ut possit patrioque prodesset est, vivendum concludaturque conclusion emque.",
                ...
                {
                    id: 52,
                    text: "Nam ei eirmod consequuntur, quod nostrum consectetuer usu ut. Vim veniam singulis senserit an. No vel liber prompta laoreet.",
                    columnWidth: 33.3
                }
            ]
        },
    ]
    res.json(columnsPage);
});

app.get('/api/blockquote-page', (req, res) => {
    const blockquotePage = [
        {
            id: 1,
            key: "blockquotePageText1",
            text: "Lorem ipsum dolor sit amet, nec in adipiscing purus luctus, urna pellentesque fringilla vel, non sed arcu integer, mauris ullamcorper ante ut non torquent. Justo praesent, vivamus eleifend torquent, suspendisse etiam lorem vestibulum, vestibulum in lorem nec vel, sit curabitur dui ligula vehicula quam. Nec in neque mauris, enim hac risus in lorem. Mi risus, feugiat egestas nunc vehicula vehicula libero. Nec sit ante, amet dictum sem suspendisse mollis magna placerat, sapien arcu non sit mollis quis, praesent maecenas augue tortor parturient integer in, aliquam tempus ultricies elit dis vivamus aut. Ipsum non ut egestas in, suspendisse ut. Sodales sed cras. Et consequat viverra. Orci urna etiam, consequat rhoncus in et.",
            blockquote: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo. At nam eros erant. Ut debet denique his, mel te fugit inermis signiferumque cum."
        },
        {
            id: 2,
            key: "blockquotePageText2",
            text: "Lorem ipsum dolor sit amet, nec in adipiscing purus luctus, urna pellentesque fringilla vel, non sed arcu integer, mauris ullamcorper ante ut non torquent. Justo praesent, vivamus eleifend torquent, suspendisse etiam lorem vestibulum, vestibulum in lorem nec vel, sit curabitur dui ligula vehicula quam. Nec in neque mauris, enim hac risus in lorem. Mi risus, feugiat egestas nunc vehicula vehicula libero. Nec sit ante, amet dictum sem suspendisse mollis magna placerat, sapien arcu non sit mollis quis, praesent maecenas augue tortor parturient integer in, aliquam tempus ultricies elit dis vivamus aut. Ipsum non ut egestas in, suspendisse ut. Sodales sed cras. Et consequat viverra. Orci urna etiam, consequat rhoncus in et.",
            blockquote: null
        }
    ]
    res.json(blockquotePage);
});

app.get('/api/scroll-slider-page', (req, res) => {
    const scrollSliderPage = [
        {
            id: 1,
            key: "scrollSliderPageText1",
            option: "text",
            header1: "Photography.",
            header2: "Mind and Soul.",
            text: "Lorem ipsum dolor sit amet, in etiam aliquid peri cula con pri. Te mea summ im unum affert padrum, sit affert dolorem summ.",
            buttonPath: ""
        },
        {
            id: 2,
            key: "scrollSliderPageImg1",
            option: "image",
            imageName: "mihail-ribkin-dBakyHCqQMA-unsplash.png",
            alt: "image"
        },
        {
            id: 3,
            key: "scrollSliderPageImg2",
            option: "image",
            imageName: "ancient-1997161_1920.png",
            alt: "image"
        },
        {
            id: 4,
            key: "scrollSliderPageImg3",
            option: "image",
            imageName: "biel-morro-kcKiBcDTJt4-unsplash2.png",
            alt: "image"
        },
        {
            id: 5,
            key: "scrollSliderPageImg4",
            option: "image",
            imageName: "sharon-mccutcheon-SavQfLRm4Do-unsplash.png",
            alt: "image"
        },
        {
            id: 6,
            key: "scrollSliderPageImg5",
            option: "image",
            imageName: "roma-kaiuk-tPt_kiEicu8-unsplash2.png",
            alt: "image"
        },
        {
            id: 7,
            key: "scrollSliderPageImg6",
            option: "image",
            imageName: "roma-kaiuk-1HN3li_kDVw-unsplash.png",
            alt: "image"
        }
    ]
    res.json(scrollSliderPage);
});

app.get('/api/portfolio-project-showcase-page', (req, res) => {
    const portfolioProjectShowcasePage = [
        {
            id: 1,
...
app.post('/api/blog-list-standard', (req, res) => {
    const blogListStandardPage = [
        ...
        {
            id: 11,
            key: "blogListStandardPageCardId11",
            cardType: "audioPost",
            header: "Audio Post 2.",
    ...
    const galleryPost = [
        {
            id: 1,
            key: "galleryPostId1",
            cardId: "blogListStandardPageCardId2",
            cardType: "galleryPost",
            header: "Gallery Post.",
            date: "11.03.2021",
            loading: false,
        ...
        },
        {
            id: 2,
            key: "galleryPostId2",
            cardId: "blogListStandardPageCardId8",
            cardType: "galleryPost",
            header: "Gallery Post 2.",
            date: "17.03.2021",
            numberOfLikes: 8,
        ...
        },
        {
            id: 3,
            key: "galleryPostId3",
            cardId: "blogListStandardPageCardId14",
            cardType: "galleryPost",
            header: "Gallery Post 3.",
            date: "17.03.2021",
            numberOfLikes: 6,
...
app.get('/api/blog-item/link-post/:id', (req, res) => {
    ...
    const linkPost = [
        ...
        },
        {
            id: 2,
            key: "linkPostId2",
            cardId: "blogListStandardPageCardId9",
            cardType: "linkPost",
            header: "Link Post 2.",
            date: "17.03.2021",
            numberOfLikes: 2,
        ...
        },
        {
            id: 3,
            key: "linkPostId3",
            cardId: "blogListStandardPageCardId15",
            cardType: "linkPost",
            header: "Link Post 3.",
            date: "17.03.2021",
            numberOfLikes: 7,
        ...
        },
        {
            id: 4,
            key: "linkPostId4",
            cardId: "blogListStandardPageCardId20",
            cardType: "linkPost",
            header: "Link Post 4.",
            date: "17.03.2021",
            numberOfLikes: 1,
    ...
    const videoPost = [
        {
            id: 1,
            key: "videoPostId1",
            cardId: "blogListStandardPageCardId6",
            cardType: "videoPost",
            header: "Video Post.",
            videoKey: "blogListVideo1",
            date: "11.03.2021",
        ...
        },
        {
            id: 2,
            key: "videoPostId2",
            cardId: "blogListStandardPageCardId12",
            cardType: "videoPost",
            header: "Video Post 2.",
            videoKey: "blogListVideo2",
            date: "11.03.2021",
        ...
        }, 
        {
            id: 3,
            key: "videoPostId3",
            cardId: "blogListStandardPageCardId18",
            cardType: "videoPost",
            header: "Video Post 3.",
            videoKey: "blogListVideo3",
            date: "11.03.2021",
